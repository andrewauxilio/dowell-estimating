<template>
<div v-if="isLoggedIn && isEDI" class="container-fluid">
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            isEDI: 'isEDI',                 //module:auth: geebung getter
    ...
    methods: {
        ...
        **/
        permissionCheck() {
            if (!this.isEDI || !this.isLoggedIn) {                              //if the user is not a geebung or not logged in
