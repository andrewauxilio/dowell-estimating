...
<div class="fab-container-dash">
    ...
    <button class="buttons">
        <i class="fab fas fa-tachometer-alt"></i>
    </button>
</div>
</template>
...
<style scoped>
@import url('../../assets/css/action-button.css');
</style>
